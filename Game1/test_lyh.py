...
while True:
    ...
    if question_response.sequence!=-1:
        ...
        if count>10:#开始不动，只要有新数据就跑一次策略
            ...
            factor_select=['avg', 'mom', 'vol', 'max52', 'cci', 'K', 'D', 'J', 'rsi','trix', 'willr', 'macd', 'natr', 'mfi']
            # index_direction='neutral'#TODO 大盘方向，用于控制exposure
            model = joblib.load('./lgb_model.pkl')

            weights = lgb_weight(dailyfactors[factor_select+['stock']],model,n=10,max_exposure=0.09)
